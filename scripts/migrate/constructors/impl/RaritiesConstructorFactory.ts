...
export const DEFAULT_RARITY_PRICE = '500000000000000000000' // 500 MANA

export class RaritiesConstructorFactory extends ConstructorFactory {
  name: ContractName = ContractName.Rarities
