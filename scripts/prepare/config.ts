...
const estateProxyAddress = "0x959e104e1a4db6317fa58f8295f586e1a978c297";
...
originContractAddresses.set(ContractName.EstateProxy, estateProxyAddress);
...
// Instead of using the original proxy contracts for these, they will use the proxy contract used by Estates.
// This is because the original for these are harder to redeploy and provide no real benefit.
originContractAddresses.set(ContractName.CatalystProxy, estateProxyAddress);
originContractAddresses.set(ContractName.POIAllowListProxy, estateProxyAddress);
originContractAddresses.set(ContractName.NameDenyListProxy, estateProxyAddress);
